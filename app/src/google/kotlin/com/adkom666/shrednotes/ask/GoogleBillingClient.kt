...
/**
 * Main tools for communication between the 'Google' and user application code.
 *
...
class GoogleBillingClient(
    ...
    override fun startConnection(listener: GoogleLikeBillingStateListener) {
        ...
        billingClient.startConnection(GoogleBillingClientStateListener(listener))
    }
    ...
    private inner class GoogleBillingClientStateListener(
